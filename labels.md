# AICoE GitHub Organization Labels
...
based on the [labels.yaml](https://github.com/AICoE/common/blob/master/labels.yaml) that it uses to
sync GitHub labels across repos in the [AICoE GitHub org](https://github.com/AICoE)
...
| Name | Description | Added By | Prow Plugin |
| ---- | ----------- | -------- | --- |
| <a id="area/comet" href="#area/comet">`area/comet`</a> | Issues or PRs related to Team Comet <br><br> This was previously `area/comet 💫`, `💫 comet`, `dizzy comet`, | label | |
| <a id="area/shooting-star" href="#area/shooting-star">`area/shooting-star`</a> | Issues or PRs related to Team Shooting Star <br><br> This was previously `area/shooting-star 🌠`, `🌠 shooting-star`, | label | |
